...
**decidim-proposals**: Fix collaborative draft attachment when attachments are enabled after collaborative draft creation [\#500](https://github.com/OpenSourcePolitics/decidim/pull/500)
