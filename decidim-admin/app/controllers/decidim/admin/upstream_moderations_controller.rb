  ...
  module Admin
    ...
    class UpstreamModerationsController < Decidim::Admin::ApplicationController
      ...
      def unreport
        ...
        Admin::UnreportUpstreamResource.call(reportable, current_user) do
          on(:ok) do
      ...
      def hide
        ...
        Admin::HideUpstreamResource.call(reportable, current_user) do
          on(:ok) do
      ...
      def participatory_space_moderations
        @participatory_space_moderations ||= Decidim::UpstreamModeration.where(participatory_space: current_participatory_space)
      end
    end
  end
end
